...
impl Tray {
    pub fn new() -> Result<Self> {
        ...
        let balanced = MenuItem::new("Switch to Balanced", true, None);
        let perf     = MenuItem::new("Switch to High Performance", true, None);
        ...
        let menu = Menu::with_items(&[&show, &sep1, &balanced, &perf, &sep2, &exit])?;
